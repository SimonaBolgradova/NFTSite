        ...
        <div className="col-lg-3 col-sm-6">
          <div className="row">
            ...
            <div className="col-lg-12">
              <div className="item">
                <h4>2.</h4>
                <img src="assets/images/author-02.jpg" alt="" style={{maxWidth: '50px', maxHeight: '50px', borderRadius: '50%'}}/>
                <h6>George br/andon<br/><a href="#">4.8 ETH or $14,000</a></h6>
              </div>
            </div>
            <div className="col-lg-12">
              <div className="item">
                <h4>3.</h4>
                <img src="assets/images/author-03.jpg" alt="" style={{maxWidth: '50px', maxHeight: '50px', borderRadius: '50%'}}/>
          ...
          <div className="row">
            ...
            <div className="col-lg-12">
              <div className="item">
                <h4>6.</h4>
                <img src="assets/images/author-03.jpg" alt="" style={{maxWidth: '50px', maxHeight: '50px', borderRadius: '50%'}}/>
                <h6>Anthony br/own<br/><a href="#">8.6 ETH or $7,400</a></h6>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-12">
              <div className="item">
                <h4>11.</h4>
                <img src="assets/images/author-02.jpg" alt="" style={{maxWidth: '50px', maxHeight: '50px', borderRadius: '50%'}}/>
                <h6>Anthony br/own<br/><a href="#">7.5 ETH or $15,400</a></h6>
              </div>
            </div>
            <div className="col-lg-12">
              <div className="item">
